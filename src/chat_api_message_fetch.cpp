...
SimpleChatApiService::FetchMessageList(grpc::CallbackServerContext *context, const None *request) {
    auto reactor = new SimpleChatApiService::MessageStreamReactor(this, context);
    reactor->Start();
    return reactor;
}
