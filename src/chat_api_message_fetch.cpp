...
class ChatApiService2::MessageStreamReactor : public grpc::ServerWriteReactor<ChatMessages>, ChatApiService2::Client {
public:
    MessageStreamReactor(ChatApiService2 *service, grpc::CallbackServerContext *context, const FetchMessageListRequest *request)
...
ChatApiService2::FetchMessageList(grpc::CallbackServerContext *context, const FetchMessageListRequest *request) {
    auto reactor = new ChatApiService2::MessageStreamReactor(this, context, request);
    reactor->Start();
    return reactor;
}
